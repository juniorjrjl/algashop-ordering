...
import com.algaworks.algashop.ordering.core.domain.model.order.OrderStatusCannotBeChangedException;
...
import com.algaworks.algashop.ordering.infrastructure.adapter.in.listener.order.OrderEventListener;
...
import static com.algaworks.algashop.ordering.core.domain.model.order.OrderStatus.CANCELED;
...
class OrderManagementApplicationServiceTest {
    ...
    private final ForManagingOrders service;
    ...
    public OrderManagementApplicationServiceTest(final Customers customers,
                                                 final Orders orders,
                                                 final ForManagingOrders service) {
