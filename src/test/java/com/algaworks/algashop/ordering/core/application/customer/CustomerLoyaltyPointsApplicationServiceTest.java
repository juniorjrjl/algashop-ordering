...
import com.algaworks.algashop.ordering.core.domain.model.customer.CantAddLoyaltyPointsOrderIsNotReady;
...
import static com.algaworks.algashop.ordering.core.domain.model.customer.LoyaltyPoints.BASE_POINTS;
import static com.algaworks.algashop.ordering.core.domain.model.order.OrderStatus.READY;
...
class CustomerLoyaltyPointsApplicationServiceTest {
    ...
    private final ForAddingLoyaltyPoints service;
    ...
    @Autowired
    public CustomerLoyaltyPointsApplicationServiceTest(final ForAddingLoyaltyPoints service,
