...
public class CustomerUpdateInputJsonDataBuilder implements JsonDataBuilder {
    ...
    public static CustomerUpdateInputJsonDataBuilder builder(){
        return new CustomerUpdateInputJsonDataBuilder();
    }
